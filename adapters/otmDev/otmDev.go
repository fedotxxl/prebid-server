...
type OtmDevAdapter struct {
	http *adapters.HTTPAdapter
	URI  string
}

// Name - export adapter name */
func (s *OtmDevAdapter) Name() string {
	return "otmDev"
}

// FamilyName used for cookies and such
func (s *OtmDevAdapter) FamilyName() string {
	return "otmDev"
}

func (s *OtmDevAdapter) SkipNoCookies() bool {
	return false
}

// Call send bid requests to otm and receive responses
func (s *OtmDevAdapter) Call(ctx context.Context, req *pbs.PBSRequest, bidder *pbs.PBSBidder) (pbs.PBSBidSlice, error) {
...
func (s *OtmDevAdapter) MakeRequests(request *openrtb.BidRequest) ([]*adapters.RequestData, []error) {
...
func (s *OtmDevAdapter) MakeBids(internalRequest *openrtb.BidRequest, externalRequest *adapters.RequestData, response *adapters.ResponseData) (*adapters.BidderResponse, []error) {
...
// NewOtmDevAdapter create a new OtmDevAdapter instance
func NewOtmDevAdapter(config *adapters.HTTPAdapterConfig, endpoint string) *OtmDevAdapter {
	return NewOtmDevBidder(adapters.NewHTTPAdapter(config).Client, endpoint)
}

func NewOtmDevBidder(client *http.Client, endpoint string) *OtmDevAdapter {
	a := &adapters.HTTPAdapter{Client: client}

	return &OtmDevAdapter{
		http: a,
		URI:  endpoint,
	}
}
