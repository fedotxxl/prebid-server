...
type OtmFakeAdapter struct {
	http *adapters.HTTPAdapter
	URI  string
}

// Name - export adapter name */
func (s *OtmFakeAdapter) Name() string {
	return "otmfake"
}

// FamilyName used for cookies and such
func (s *OtmFakeAdapter) FamilyName() string {
	return "otmfake"
}

func (s *OtmFakeAdapter) SkipNoCookies() bool {
	return false
}

// Call send bid requests to otm and receive responses
func (s *OtmFakeAdapter) Call(ctx context.Context, req *pbs.PBSRequest, bidder *pbs.PBSBidder) (pbs.PBSBidSlice, error) {
...
func (s *OtmFakeAdapter) MakeRequests(request *openrtb.BidRequest) ([]*adapters.RequestData, []error) {
...
func (s *OtmFakeAdapter) MakeBids(internalRequest *openrtb.BidRequest, externalRequest *adapters.RequestData, response *adapters.ResponseData) (*adapters.BidderResponse, []error) {
...
// NewOtmFakeAdapter create a new OtmFakeAdapter instance
func NewOtmFakeAdapter(config *adapters.HTTPAdapterConfig, endpoint string) *OtmFakeAdapter {
	return NewOtmFakeBidder(adapters.NewHTTPAdapter(config).Client, endpoint)
}

func NewOtmFakeBidder(client *http.Client, endpoint string) *OtmFakeAdapter {
	a := &adapters.HTTPAdapter{Client: client}

	return &OtmFakeAdapter{
		http: a,
		URI:  endpoint,
	}
}
